...
public class MeepMeepTesting {
    public static void main(String[] args) { //-70,45.6 ,44.6, 64.5
        ...
        RoadRunnerBotEntity clankerTestsBot = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(60, 60, Math.PI, Math.PI, 15).setDimensions(17.5,15.5)
                .build();

        TrajectoryActionBuilder john = clankerTestsBot.getDrive().actionBuilder(new Pose2d(-38,56,0))
                .setTangent(-Math.PI / 4)
                .splineToSplineHeading(new Pose2d(-24,36,Math.PI / 4),-Math.PI/4)
//                .waitSeconds(0.5)
                .setTangent(Math.PI / 4)
                ...
                ;
        clankerTestsBot.runAction(john.build());
