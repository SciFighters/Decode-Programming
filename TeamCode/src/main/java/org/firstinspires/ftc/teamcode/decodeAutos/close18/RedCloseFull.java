...
@Autonomous(name = "18 red close Full", group = "red close")
public class RedCloseFull extends ActionOpMode {
...
//                                                new InstantCommand(() -> DischargeSubsystem.shooting = false),
                                ...
                                new ParallelCommandGroup(
                                        ...
                                        new SequentialCommandGroup(
                                                ...
                                                new CommandGroups.StartOuttake(intake, carousel).withTimeout(200),
                                                new CommandGroups.PrepareShooting(intake, carousel, mecanumDrive))
                                ),
                                new ParallelCommandGroup(
                                        new SequentialCommandGroup(
